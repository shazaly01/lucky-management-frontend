  ...
  >
    <div class="flex h-16 items-center justify-between px-5 flex-shrink-0">
      <RouterLink :to="{ name: 'Dashboard' }" class="flex items-center gap-2">
        ...
        <h1 class="text-xl font-bold text-text-primary">المسابقات</h1>
      </RouterLink>
      <button
...
// --- بنية البيانات الجديدة لنظام الفندق والقرعة ---
const allNavLinks = shallowRef([
...

  {
    ...
    children: [
      ...
      {
        name: 'سجل الفائزين',
        routeName: 'LotteryIndex', // تأكد من تسمية مسار عرض السجل في الراوتر
        permission: 'lottery_draw.view',
      },
    ],
  },
